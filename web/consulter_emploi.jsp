...
<html>
    ...
    <body>
        ...
        <fieldset>
                ...
                <legend style="color:red;">liste des cemploi</legend>
                <br>  <br>  
       
    <img src="bannire.jpg" width="200" alt="200" />
    <hr>
         <h1 style="text-align:center;color:blue;">consulter les cours des diferents emploi du temps</h1>
         <hr><br>
    ...
    try{
       ...
       String var="emploi";
        ...
        rst=ps.executeQuery();
        out.println(" <h2>la liste des emploi présents</h2>");out.println(" <br>");out.println(" <br>");
                    while (rst.next())
                    {out.println("<b> <---- les informations du chaque emploi ---></b>");out.println(" <br>");
