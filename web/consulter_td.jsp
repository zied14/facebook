...
<html>
    ...
    <hr>
         <h1 style="text-align:center;color:blue;">consulter les td,tp des diferents matieres</h1>
         <hr><br>
    ...
    try{
       ...
       String var="tp";
        ...
        rst=ps.executeQuery();
        out.println(" <h2>la liste des td présents</h2>");out.println(" <br>");out.println(" <br>");
                    while (rst.next())
                    {out.println("<b> <---- les informations du chaque td ---></b>");out.println(" <br>");
