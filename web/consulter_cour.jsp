...
<html>
    ...
    <hr>
         <h1 style="text-align:center;color:blue;">consulter les cours des diferents matieres</h1>
         <hr><br>
    ...
    try{
       ...
       String var="cour";
        ...
        rst=ps.executeQuery();
        out.println(" <h2>la liste des cours présents</h2>");out.println(" <br>");out.println(" <br>");
                    while (rst.next())
                    {out.println("<b> <---- les informations du chaque cour ---></b>");out.println(" <br>");
                     ...
                     out.println("l'enseigniant qui l'oploder :"+rst.getString("nom_per"));out.println(" <br>");
